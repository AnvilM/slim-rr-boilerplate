...
```bash
composer create-project vendor/slim-roadrunner-boilerplate my-project
```
...
```bash
git clone https://github.com/your-username/slim-roadrunner-boilerplate.git my-project
cd my-project
composer install
```
